var sendsvg = document.querySelector(".chatbox__input svg");
var sendbtn = document.querySelector(".chatbox__input button");
...
var messageController = (function () {
  ...
  return {
    sendMessage: function () {
      ...
      var message = `<img src="./sender.jpg"/>
    ...
    starkReply: function () {
      var reply =
        starkQuotes[Math.floor(Math.random() * starkQuotes.length - 1) + 1];
      var message_container = document.createElement("div");
      var message = `<img src="./service.jpg"/>
...
var init = (function (messageController) {
  ...
  function handler(e) {
    if (e.target == sendbtn || e.target == sendsvg || e.keyCode == 13) {
